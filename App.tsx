...
import ExportOptionsModal from './components/ExportOptionsModal'; // New Import
...
const App: React.FC = () => {
  ...
  const [isExportOptionsModalOpen, setIsExportOptionsModalOpen] = useState(false); // New state for export options
